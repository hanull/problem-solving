...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(solution("line", new String[]{"-s STRINGS", "-n NUMBERS", "-e NULL"}, new String[]{"line -n 100 102 -s hi -e", "line -n id pwd -n 100"})));
        System.out.println(Arrays.toString(solution("trip", new String[]{"-days NUMBERS", "-dest STRING"}, new String[]{"trip -days 15 10 -dest Seoul Paris", "trip -days 10 -dest Seoul"})));
    }
}
